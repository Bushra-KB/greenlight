...
import DeleteRecordingForm from '../recordings/forms/DeleteRecordingForm';
...
const WORKSPACE_COPY = {
  ...
  tr: {
    ...
    workspace: {
      ...
      body: 'Odalar, kayıtlar, planlama, analitik ve yönetim için rol bazlı alan.',
      roleScope: 'Mevcut erişim alanı',
      quickActions: 'Hızlı işlemler',
      phaseNote: '',
    },
    visuals: {
      title: 'Görsel Özet',
      occupancy: 'Canlı oran',
      breakdown: 'Oda Durumu',
      live: 'Canlı',
      idle: 'Boş',
      shared: 'Paylaşımlı',
      access: 'Erişim',
      recordingsOn: 'Kayıt açık',
      recordingsOff: 'Kayıt kapalı',
      stateOn: 'Açık',
      stateOff: 'Kapalı',
    },
    insights: {
      trend: 'Toplantı Trendi',
      topRooms: 'En Aktif Odalar',
      noTrend: 'Yeni toplantı yok.',
      noRooms: 'Oda etkinliği yok.',
      users: 'kullanıcı',
      sessions: 'oturum',
      participants: 'katılımcı',
    },
    recordingsDetail: {
      title: 'Kanıt İnceleme',
      room: 'Oda',
      selectRoom: 'Oda seçin',
      meetings: 'Geçmiş Toplantılar',
      noMeetings: 'Geçmiş toplantı yok.',
      users: 'Kullanıcı Kanıtları',
      noUsers: 'Toplantı seçin.',
      loading: 'Yükleniyor...',
      date: 'Tarih',
      meeting: 'Toplantı',
    ...
    adminWidgets: {
      ...
      schedule: 'Planlama',
      rooms: 'Sunucu Odaları',
      sections: 'Yönetim Alanları',
      presets: 'Hazır Filtreler',
      presetExport: 'Dışa Aktarım',
      presetSchedule: 'Planlama',
      presetAttendance: 'Yoklama',
      presetAdmin: 'Yönetim',
    },
    adminControls: {
      roomRules: 'Oda Kuralları',
      liveControls: 'Canlı Kontroller',
      room: 'Oda',
      selectRoom: 'Oda seçin',
      meeting: 'Toplantı',
      selectMeeting: 'Toplantı seçin',
      enabled: 'Aktif',
      interval: 'Aralık',
      jitter: 'Jitter',
      ttl: 'TTL',
      maxMissed: 'Maks kaçırma',
      updatedBy: 'Güncelleyen',
      load: 'Yükle',
      save: 'Kaydet',
      attendanceTtl: 'Yoklama TTL',
      issueAttendance: 'Yoklama Gönder',
      quizPrompt: 'Quiz sorusu',
      quizExpected: 'Beklenen cevap',
      quizTtl: 'Quiz TTL',
      issueQuiz: 'Quiz Gönder',
      requiredRoom: 'Oda seçin.',
      requiredMeeting: 'Toplantı seçin.',
      requiredQuiz: 'Soru ve beklenen cevap gerekli.',
      roomRulesLoaded: 'Oda kuralları yüklendi.',
      roomRulesSaved: 'Oda kuralları kaydedildi.',
      roomRulesError: 'Oda kuralları isteği başarısız.',
      liveLoaded: 'Canlı kontroller yüklendi.',
      liveSaved: 'Canlı kontroller kaydedildi.',
      liveError: 'Canlı kontrol isteği başarısız.',
      issueDone: 'Kontrol gönderildi.',
      issueError: 'Gönderim isteği başarısız.',
      overviewTitle: 'Yönetim Özeti',
      manageUsersTab: 'Kullanıcılar',
      serverRoomsTab: 'Sunucu Odaları',
      roomConfigTab: 'Oda Yapılandırma',
      siteSettingsTab: 'Site Ayarları',
      rolesTab: 'Roller',
      auditLogsTab: 'Denetim Kayıtları',
      manageUsersBody: 'Doğrulama, roller ve erişim için kullanıcı yönetim ekranını açın.',
      serverRoomsBody: 'Tüm sunucu oda envanterini inceleyin ve yönetin.',
      roomConfigBody: 'Bu alandan oda kuralları ve canlı kontrolleri yönetin.',
      siteSettingsBody: 'Greenlight markalama, kayıt ve platform davranışını özelleştirin.',
      rolesBody: 'Özel roller ve izin setlerini yönetin.',
    ...
    roomsPanel: {
      ...
      body: 'Aktif odaları ve kursları yönetin.',
    },
    recordingsPanel: {
      title: 'Tüm Kayıtlar',
      body: 'Tüm odalardaki kayıtları arayın, filtreleyin ve inceleyin.',
      filtersTitle: 'Kayıt panosu',
      room: 'Oda',
      allRooms: 'Tüm odalar',
      visibility: 'Görünürlük',
      allVisibility: 'Tüm görünürlükler',
      search: 'Ara',
      searchPlaceholder: 'Kayıt adı veya oturum ID ara',
      resetFilters: 'Filtreleri sıfırla',
      tableTitle: 'Tüm Kayıtlar',
      tableBody: 'Erişiminiz olan tüm oda ve oturum kayıtları.',
      recordingCol: 'Kayıt',
      roomCol: 'Oda',
      recordedCol: 'Kayıt Tarihi',
      durationCol: 'Süre',
      participantsCol: 'Katılımcılar',
      visibilityCol: 'Görünürlük',
      formatsCol: 'Formatlar',
      actionsCol: 'Seçenekler',
      open: 'İzle',
      download: 'İndir',
      delete: 'Sil',
      deleteTitle: 'Kaydı sil',
      statsTotal: 'Toplam kayıt',
      statsFiltered: 'Filtrelenen sonuç',
      statsFormats: 'Mevcut format',
      statsParticipants: 'Sayfadaki katılımcı',
      loading: 'Kayıtlar yükleniyor...',
      noMatches: 'Mevcut filtrelerle eşleşen kayıt yok.',
    },
    schedulePanel: {
      title: 'Tüm Oturumlar',
      body: 'Odalardaki oturumları görüntüleyin ve yönetin.',
      ...
      search: 'Ara',
      searchPlaceholder: 'Başlık, açıklama, oluşturan',
      resetFilters: 'Filtreleri sıfırla',
      reload: 'Yenile',
      openPlanner: 'Planlayıcıyı aç',
      closePlanner: 'Planlayıcıyı kapat',
      plannerTitle: 'Gelecek oturum planla',
      plannerBody: 'Planlı bir oturum oluşturun ve hangi odada olacağını seçin.',
      titleLabel: 'Başlık',
      ...
      globalIcs: 'Genel ICS',
      roomIcs: 'Oda ICS',
      tableTitle: 'Tüm Oturumlar',
      tableBody: 'Mevcut odalardaki yaklaşan, canlı ve tamamlanan oturumlar.',
      startCol: 'Başlangıç',
      endCol: 'Bitiş',
      sessionCol: 'Oturum',
      roomCol: 'Oda',
      sourceCol: 'Kaynak',
      participantsCol: 'Katılımcı',
      durationCol: 'Süre',
      statusCol: 'Durum',
      actionsCol: 'Seçenekler',
      sourcePlanner: 'Planlayıcı',
      sourceMeeting: 'BBB toplantı',
      ...
      statsLoaded: 'Yüklenen oturum',
      statsUpcoming: 'Yaklaşan',
      statsLive: 'Şimdi canlı',
      statsCompleted: 'Tamamlanan',
      nextStart: 'Sıradaki başlangıç',
      noNextStart: 'Yaklaşan oturum yok',
      loading: 'Oturumlar yükleniyor...',
      noSessions: 'Oturum bulunamadı.',
      noMatches: 'Mevcut filtrelerle eşleşen oturum yok.',
      ...
      next: 'Sonraki',
      close: 'Kapat',
      requiredFields: 'Oda, başlık, başlangıç ve bitiş zorunludur.',
      createdMessage: 'Gelecek oturum oluşturuldu.',
      startedNowMessage: 'Oturum şimdi başlatıldı.',
      cancelledMessage: 'Gelecek oturum iptal edildi.',
      loadedMessage: 'oturum yüklendi.',
      sessionId: 'Oturum ID',
      creator: 'Oluşturan',
      descriptionFallback: 'Açıklama girilmedi.',
      detailRoom: 'Oda',
      detailStart: 'Başlangıç',
      detailEnd: 'Bitiş',
      detailTimezone: 'Saat dilimi',
      detailIcs: 'Oda ICS',
      detailOpenRoom: 'Odayı aç',
      futureDetailsTitle: 'Gelecek oturum detayları',
      reportTitle: 'Oturum raporu',
      reportLoading: 'Oturum raporu yükleniyor...',
      reportEmpty: 'Oturum raporu verisi bulunamadı.',
      reportParticipants: 'Katılımcılar',
      reportAttendance: 'Yoklama skoru',
      reportActivity: 'Aktivite skoru',
      reportEvents: 'Etkinlikler',
      reportExports: 'Dışa aktarımlar',
      exportExcel: 'Excel indir',
      exportCsv: 'CSV indir',
      exportJson: 'JSON indir',
      detailAction: 'Detay',
      participantDetailTitle: 'Katılımcı detayı',
      participantDetailSubtitle: 'Bu oturum için ayrıntılı katılım, dikkat ve devam kanıtları.',
      statusLabel: 'Durum',
      statusStrong: 'Güçlü',
      statusWatch: 'İzle',
      statusRisk: 'Riskli',
      statusNoEvidence: 'Kanıt Yok',
      ...
      webcamTime: 'Webcam süresi',
      messagesLabel: 'Mesajlar',
      reactionsLabel: 'Tepkiler',
      raiseHandsLabel: 'El Kaldırma',
      whiteboardAnnotationsLabel: 'Beyaz Tahta Notları',
      sharedNotesLabel: 'Paylaşılan Notlar',
      analyticsTab: 'Analitik',
      checksTab: 'Kontroller',
      attributeName: 'Özellik',
      attributeValue: 'Skor / Değer',
      cards: [
        {
    ...
    analyticsPanel: {
      ...
      body: 'Etkileşim, skorlar, çıktılar ve denetim görünümü.',
      cards: [
        {
          title: 'Öğrenme Analitiği',
          body: '',
          href: '/learning-analytics-dashboard/',
        },
        {
          title: 'Uyumluluk Bileşenleri',
          body: '',
        },
      ],
    },
    adminPanel: {
      title: 'Yönetim ve Denetim Kontrolleri',
    ...
    shortcuts: {
      rooms: 'Oda operasyonları',
      recordings: 'Kayıtları incele',
      schedule: 'Gelecek oturumları planla',
      analytics: 'Analitiği aç',
      admin: 'Yönetim kontrolleri',
    },
    access: {
      create: 'Oda oluşturma',
      recordings: 'Kayıt akışı',
      manageRooms: 'Oda yönetimi',
      manageUsers: 'Kullanıcı yönetimi',
      manageSettings: 'Platform ayarları',
      shared: 'Paylaşımlı oda görünürlüğü',
    },
  },
};
...
function RecordingsWorkspace({
  ...
  const currentUser = useAuth();
  const canDeleteRecordings = PermissionChecker.hasManageRecordings(currentUser);
                    ...
                    <td>
                      <div className="ak-workspace-inline-actions ak-workspace-inline-actions-wrap ak-workspace-row-actions">
                        {openHref && (
                          <a
                            href={openHref}
                            className="ak-workspace-action-icon-btn"
                            target="_blank"
                            rel="noreferrer"
                            title={recordingsCopy.open}
                            aria-label={recordingsCopy.open}
                          >
                            <ArrowTopRightOnSquareIcon aria-hidden="true" />
                            <span className="visually-hidden">{recordingsCopy.open}</span>
                          </a>
                        )}
                        {openHref && (
                          <a
                            ...
                            className="ak-workspace-action-icon-btn"
                            download
                            title={recordingsCopy.download}
                            aria-label={recordingsCopy.download}
                          >
                            <ArrowDownTrayIcon aria-hidden="true" />
                            <span className="visually-hidden">{recordingsCopy.download}</span>
                          </a>
                        )}
                        {canDeleteRecordings && (
                          <InlineModal
                            title={recordingsCopy.deleteTitle}
                            modalButton={(
                              <button
                                type="button"
                                className="ak-workspace-action-icon-btn is-danger"
                                title={recordingsCopy.delete}
                                aria-label={recordingsCopy.delete}
                              >
                                <TrashIcon aria-hidden="true" />
                                <span className="visually-hidden">{recordingsCopy.delete}</span>
                              </button>
                            )}
                            body={(
                              <DeleteRecordingForm
                                mutation={useDeleteRecording}
